...
public class Partenaire {
    ...
    @DecimalMin(value = "-90.0",  message = "Latitude minimum : -90")
    @DecimalMax(value = "90.0",   message = "Latitude maximum : 90")
    @Column(nullable = false)
    private Double latitude;

    @NotNull(message = "La longitude est obligatoire")
    @DecimalMin(value = "-180.0", message = "Longitude minimum : -180")
    @DecimalMax(value = "180.0",  message = "Longitude maximum : 180")
    @Column(nullable = false)
    ...
    public Double getPlafondPriseEnCharge() { return plafondPriseEnCharge; }
    public void setPlafondPriseEnCharge(Double plafond) { this.plafondPriseEnCharge = plafond; }
